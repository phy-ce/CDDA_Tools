...
UI_STRINGS = {
    "en": {
        ...
        "tool_used_in": "Used as a tool to craft ({n})",
        ...
        "quality_recipes_label": "Recipes requiring this quality ({n})",
        ...
        "col_thick": "Thickness", "col_env": "Env", "col_cal": "Calories", "col_quench": "Quench",
        "protection_label": "Protection", "arm_phys": "Physical", "arm_env": "Environmental",
        "arm_fit": "Fit", "covers": "Covers",
    ...
    "ko": {
        ...
        "quality_recipes_label": "이 품질을 요구하는 레시피 ({n})",
        ...
        "col_thick": "두께", "col_env": "환경", "col_cal": "칼로리", "col_quench": "갈증 해소",
        "protection_label": "방어", "arm_phys": "물리", "arm_env": "환경",
        "arm_fit": "착용", "covers": "보호 부위",
    ...
    "ja": {
        ...
        "quality_recipes_label": "この品質を要求するレシピ ({n})",
        ...
        "col_thick": "厚さ", "col_env": "環境", "col_cal": "カロリー", "col_quench": "水分",
        "protection_label": "防御", "arm_phys": "物理", "arm_env": "環境",
        "arm_fit": "装備", "covers": "保護部位",
